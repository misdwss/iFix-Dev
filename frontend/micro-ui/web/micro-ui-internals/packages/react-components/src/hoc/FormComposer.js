...
export const FormComposer = (props) => {
  ...
  const isFsmNewApplication =
    location.pathname.includes(`digit-ui/employee/fsm/new-application`) || location.pathname.includes(`digit-ui/employee/fsm/modify-application`);
