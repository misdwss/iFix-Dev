...
@SpringBootTest
class FiscalEventMapperUtilTest {
    ...
    void init() throws IOException {
        ...
        jsonNode = mapper.convertValue(fiscalEventSearchResponse.getFiscalEvent(), JsonNode.class);
    }

    @Test
    void testMapDereferencedFiscalEventToFiscalEventWithEmptyList() throws IllegalArgumentException {
        when(this.objectMapper.convertValue((Object) any(), (Class<Object>) any()))
                .thenReturn(new ArrayNode(new JsonNodeFactory(true)));
        assertTrue(this.fiscalEventMapperUtil.mapDereferencedFiscalEventToFiscalEvent(new ArrayList<Object>()).isEmpty());
