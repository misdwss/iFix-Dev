 ...
 * org.egov.repository.querybuilder.FiscalEventQueryBuilder; import
 ...
 * 
 * @SpringBootTest class FiscalEventRepositoryTest {
 * 
 * @InjectMocks private FiscalEventRepository repository;
 * 
 * @Mock private MongoTemplate mongoTemplate;
 * 
 * @Mock private FiscalEventQueryBuilder eventQueryBuilder;
 * 
 ...
 * 
 * @Test void searchFiscalEvent() { Query searchQuery =
 * eventQueryBuilder.buildSearchQuery(fiscalEventGetRequest.getCriteria());
 * 
 * doReturn(fiscalEventSearchResponse.getFiscalEvent()).when(mongoTemplate).find
 * (searchQuery, Object.class, "fiscal_event");
 * 
 * List<Object> fiscalEventsActual = mongoTemplate.find(searchQuery,
 * Object.class, "fiscal_event"); assertNotNull(fiscalEventsActual);
 * assertTrue(fiscalEventsActual.size() > 0); }
 * 
 * @Test void searchFiscalEventEmptyResult() { Query searchQuery =
 * eventQueryBuilder.buildSearchQuery(fiscalEventGetRequest.getCriteria());
 * 
 * doReturn(new ArrayList<>()).when(mongoTemplate).find(searchQuery,
 * Object.class, "fiscal_event");
 * 
 * List<Object> fiscalEventsActual = mongoTemplate.find(searchQuery,
 * Object.class, "fiscal_event"); assertNotNull(fiscalEventsActual);
