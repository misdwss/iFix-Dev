 ...
 * 
 * 
 * import com.github.cloudyrock.mongock.ChangeLog; import
 * com.github.cloudyrock.mongock.ChangeSet; import
 * com.mongodb.client.MongoCollection; import com.mongodb.client.MongoDatabase;
 * import com.mongodb.client.model.Indexes; import lombok.extern.slf4j.Slf4j;
 * import org.bson.Document;
 * 
 * 
 * @ChangeLog(order = "V20220215113000")
 * 
 * @Slf4j public class V20220215113000_MongoIndexScript {
 * 
 ...
 *//**
	 ...
	 */
/*
 * @ChangeSet(id = "V20220215113000_createGovernmentIndex", author =
 * MDS_INDEX_AUTHOR, order = "001") public void
 * createGovernmentIndex(MongoDatabase db) { MongoCollection<Document>
 * mongoCollection = db.getCollection("government");
 * 
 ...
 *//**
	 * @param db
	 *//*
		 * @ChangeSet(id = "V20220215113000_createChartOfAccountIndex", author =
		 * MDS_INDEX_AUTHOR, order = "002") public void
		 * createChartOfAccountIndex(MongoDatabase db) { MongoCollection<Document>
		 * mongoCollection = db.getCollection("chartOfAccount");
		 * 
