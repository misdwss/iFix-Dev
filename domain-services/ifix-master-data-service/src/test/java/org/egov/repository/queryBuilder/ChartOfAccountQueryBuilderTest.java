...
class ChartOfAccountQueryBuilderTest {
    ...
    void testBuildSearchQuery() {
        Query actualBuildSearchQueryResult = this.chartOfAccountQueryBuilder.buildSearchQuery(new COASearchCriteria());
    ...
    void testBuildSearchQueryWithSearchCriteria() {
        ...
        Query actualBuildSearchQueryResult = this.chartOfAccountQueryBuilder
