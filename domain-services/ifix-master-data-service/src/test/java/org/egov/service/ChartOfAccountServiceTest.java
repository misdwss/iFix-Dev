 ...
 * org.egov.validator.ChartOfAccountValidator; import
 ...
 * 
 * @SpringBootTest() class ChartOfAccountServiceTest {
 * 
 ...
 * 
 * @Mock private COAEnrichmentService coaEnrichmentService;
 * 
 ...
 * 
 * @InjectMocks private ChartOfAccountService chartOfAccountService;
 * 
 ...
 * 
 * @Test void chartOfAccountV1CreatePost() {
 ...
 * ));
 * 
 * COARequest savedCoaRequest =
 * chartOfAccountService.chartOfAccountV1CreatePost(coaRequest);
 * 
 * assertEquals(savedCoaRequest, coaRequest); }
 * 
 * @Test void chartOfAccountV1CreatePostException() { doThrow(new
 * CustomException()).when(chartOfAccountValidator).validateCreatePost(
 * headlessCoaRequest);
 * 
 * assertThrows(CustomException.class, () ->
 * chartOfAccountValidator.validateCreatePost(headlessCoaRequest)); }
 * 
 * @Test void chartOfAccountV1SearchPost() {
 ...
 * 
 * @Test void chartOfAccountV1SearchPostException() { doThrow(new
 * CustomException()).when(chartOfAccountValidator).validateSearchPost(
 * coaSearchRequest);
 * 
 * assertThrows(CustomException.class, () ->
