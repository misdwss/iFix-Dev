...
class DepartmentValidatorTest {
    ...
    @Test
    void testValidateCreateRequestDataTenantIdLengthException() {
        departmentCreateRequest.getDepartment().setTenantId("0");
    ...
    @Test
    void testValidateCreateRequestDataTenantIdNonExistException() {
        doReturn(false).when(tenantUtil).validateTenant(departmentCreateRequest.getDepartment().getTenantId(),
                departmentCreateRequest.getRequestHeader());

        assertThrows(CustomException.class,
                () -> departmentValidator.validateCreateRequestData(departmentCreateRequest),
                "Tenant id's doesn't exist in the system");
    }
    ...
    void testValidateCreateRequestDataParentException() {
        ...
        doReturn(true).when(tenantUtil).validateTenant(departmentCreateRequest.getDepartment().getTenantId(),
                departmentCreateRequest.getRequestHeader());
