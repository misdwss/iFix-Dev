...
class PspclBillAndPaymentReconcileServiceImplTest {
    ...
    List<GetBillResult> getBillResults;
    List<GetPaymentResult> getPaymentResults;
    ...
    @Test
    void reconcileWithEmptyBillAndPayment() {
    ...
    @Test
    void reconcileWithBillAndPayment() {
        PspclBillDetail currentPspclBillDetail = new PspclBillDetail();
        PspclPaymentDetail currentPspclPaymentDetail = new PspclPaymentDetail();
    ...
    @Test
    void publishFiscalEventWithEmptyReconcileVOs() {
    ...
    @Test
    void publishFiscalEventWithReconcileVOs() {
        List<ReconcileVO> reconcileVOS = new ArrayList<>();
        ...
        reconcileVO.setCurrentCalculatedBillAmt(new BigDecimal("23456"));
