...
(
    ...
    bill_issue_date              character varying(255),
    bill_no                      character varying(255),
    date_reading_curr            character varying(255),
    date_reading_prev            character varying(255),
...
(
    ...
    bilissdt        character varying(255),
    bilno           character varying(255),
    duedtcash       character varying(255),
    duedtchq        character varying(255),
    status_p        character varying(255),
    txndate         character varying(255),
