                    ...
                    if (tenantList == null || tenantList.isEmpty()) {
                        ...
                        for (Tenant tenant : tenantList) {
                            if (FISCAL_EVENT_RECEIPT.equalsIgnoreCase(eventType)) {
                                try {
                                    List<CreateChallanRequestDTO> updateChallanRequestList =
                                            wrapUpdateChallanRequestDTO(fiscalEvent, tenant.getCode());

                                    for (CreateChallanRequestDTO createChallanRequest : updateChallanRequestList) {
                                        CreateChallanResponseDTO createChallanResponse = mgramsevaChallanRepository
                                                .pushMgramsevaUpdateChallanAPI(createChallanRequest);
