...
public class PostEvent {
	 ...
	 * 
	 * @return token
	 *  Get the keyCloak Bearer token from redis
	...
	private String getAuthToken() {
		...
		if(token==null)
		{
			String url=applicationConfiguration.getKeyCloakHost()+applicationConfiguration.getKeyCloakAuthEndPoint();
			...
			// store the expires and then check evertime to find out to call refresh api or not 
			}
